...
<head>
    ...
    <script type="text/javascript">
        ...
        function MouseOverSubmenuItem(source) {
            if (source.style) {
                source.style.backgroundColor = "#FD9311";
            }
        }

        function MouseOutSubmenuItem(source) {
            if (source.style) {
                source.style.backgroundColor = "#01200a";
            }
        }
    </script>
            ...
            <div id="MenuColumn">
                ...
                <div id="Loginbox">
                    ...
                    <div id="BorderLeft" class="LoginBorder"
                         style="background-image:url(<?= $template_path; ?>/images/general/chain.png)"></div>
                ...
                <div class="SmallMenuBox" id="DownloadBox">
                    ...
                    <div class="SmallBoxBorder"
                         style="background-image:url(<?= $template_path; ?>/images/global/general/chain.png);"></div>
...
<head>
    ...
    <style>
        ...
        .gtranslate_wrapper img {
            ...
            border-radius: 2px; /* Adiciona bordas arredondadas para um efeito mais suave */
        }
    </style>
</head>
<body>
                                    ...
                                    <?php if (!empty($config['instagram_link'])) { ?>
                                        ...
                                        <span class="InfoBarNumbers">
                                            <a class="InfoBarLinks" href="https://www.instagram.com/<?= $config['instagram_link']; ?>"
                                               target="new"><span class="InfoBarSmallElement"><b>Instagram</b></span></a>
                                        </span>
                                    ...
                                    <?php if (!empty($config['facebook_link'])) { ?>
                                        ...
                                        <span class="InfoBarNumbers">
                                            <a class="InfoBarLinks" href="https://www.facebook.com/<?= $config['facebook_link']; ?>"
                                               target="new"><span class="InfoBarSmallElement"><b>Facebook</b></span></a>
                                        </span>
...
<?php
// Verifica se a página atual é a 'news.php' usando $_GET['news']
if (isset($_GET['news'])) {
    // Código para exibir o conteúdo apenas na página news.php
    ?>
    <div id="newsticker" class="Box">
        ...
        <div class="BorderTitleText" style="background-image: url(templates/tibiacom/images/content/title-background-green2.gif);"></div>
        <img class="Title" src="templates/tibiacom/images/header/headline-feature.png" alt="Contentbox headline">
        <div class="Border_2">
            <div class="Border_3">
                <div class="BoxContent" style="background-image: url(templates/tibiacom/images/content/scroll.gif);">
                    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                        <div style="font-size: 14px; line-height: 1.5; text-align: center; flex-grow: 1;">
                            <br />
                            <b>IP:</b> lattorre.com | <b>Exp:</b> 200x | <b>New Updates</b> | <b>Versão:</b> 15.11
                            <br /><br />
                            Bem-vindo ao <b><?php echo $config['server']['serverName']; ?></b>, um servidor único o aguarda.
                            <br /><br />
                            Baixe o <b>cliente próprio</b>, <b>monte sua guilda</b> e <b>prepare-se para muita diversão e guerras!</b>
                            <br /><br />
                        </div>
                        <div id="TeaserThumbnail" style="flex-shrink: 0; margin-left: 10px; text-align: right;">
                            <img src="images/announcement.gif" width="150" height="80" border="0" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    // Adiciona o listener ao botão de copiar
    var copyButton = document.getElementById("copyButton");
    if (copyButton) {
        copyButton.addEventListener("click", function() {
            var qrCodeText = document.getElementById("qrCode").innerText;

            // Cria um input temporário para copiar o conteúdo
            var tempInput = document.createElement("input");
            tempInput.value = qrCodeText;
            
            // Adiciona o input temporário ao documento
